...
<html>
	<head>
	    ...
	    function  goNewPage()
	    {
	     ...
	     form1.action='<%=request.getContextPath()%>'+'/jsp/waitingBill/waiting_bill_list.jsp';
...
<body leftmargin="0" topmargin="0" rightmargin="0">
	...
	<input name="reserveTime" type="hidden" value="<%=reserveTime%>"/>
	<input name="callType" type="hidden" value="<%=callType%>"/>
