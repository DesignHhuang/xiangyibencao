...
import com.blisscloud.util.DataPage;

public class SimpleDataPageBean {

	public SimpleDataPageBean() {
	...
	private int currentPageNumber;// ����ǰҳ��
	private int eachPageRowLimit;// ÿҳ�������
	private int rowLimit;// �ܹ������У�
	private int pageNumberLimit;// �ܹ�����ҳ��
